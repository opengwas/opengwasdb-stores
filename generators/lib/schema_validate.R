...
# scripts shell out to generators/lib/schema_validate.py rather than hand-
...
validate_against_opengwasdb_schema <- function(analyses_path, root) {
  ...
  script <- normalizePath(file.path(root, "generators/lib/schema_validate.py"), winslash = "/", mustWork = FALSE)
