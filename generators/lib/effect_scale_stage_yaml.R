...
## reference-AF effect-scale validation stage (generators/lib/effect_scale_validation.R),
...
## small generic helpers -- see generators/lib/gwas_catalog_ssf_url.R's header
