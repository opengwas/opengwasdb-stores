...
script_version <- function(root) {
  path <- path_abs(root, "generators/lib/source-formats/opengwas-gwas-vcf-dense/generate.R")
...
# n_controls for every id via generators/lib/metadata_resolvers/
...
emit_bundle <- function(cfg, root, max_analyses = NA_integer_, only_analysis_id = "") {
  ...
  command <- paste("Rscript generators/lib/source-formats/opengwas-gwas-vcf-dense/generate.R",
  ...
  write_yaml_file(list(
    ...
    accepted_at = NULL,
    generator = list(
      name = "generators/lib/source-formats/opengwas-gwas-vcf-dense/generate.R",
  ...
  write_yaml_file(list(
    ...
    validator = list(name = "generators/lib/source-formats/opengwas-gwas-vcf-dense/generate.R", version = NULL),
    checks = list(
      schema = "not_run",
      files = "not_run",
...
root <- repo_root()
source(path_abs(root, "generators/lib/metadata_resolvers/opengwas_api.R"))
...
source(path_abs(root, "generators/lib/opengwas_gwas_vcf_dense.R"))
