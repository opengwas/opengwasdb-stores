...
script_version <- function(root) {
  path <- path_abs(root, "generators/lib/source-formats/gwas-ssf-ragged/generate.R")
...
emit_bundle <- function(cfg, root) {
  ...
  command <- paste("Rscript generators/lib/source-formats/gwas-ssf-ragged/generate.R",
  ...
  write_yaml_file(list(
    ...
    accepted_at = NULL,
    generator = list(
      name = "generators/lib/source-formats/gwas-ssf-ragged/generate.R",
  ...
  write_yaml_file(list(
    status = "not_run",
    validated_at = NULL,
    validator = list(name = "generators/lib/source-formats/gwas-ssf-ragged/generate.R", version = NULL),
    checks = list(
      schema = "not_run",
      files = "not_run",
