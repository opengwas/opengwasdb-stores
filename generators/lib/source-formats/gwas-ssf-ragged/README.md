...
This uses the shared engine at `generators/lib/effect_scale_validation.R` to
...
`generators/lib/release_yaml.py::merge_validation_yaml` helper the effect-scale
