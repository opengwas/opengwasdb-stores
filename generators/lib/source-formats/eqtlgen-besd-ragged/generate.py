...
from generators.lib.release_yaml import (  # noqa: E402
    get,
...
def main() -> None:
    ...
    from generators.lib.build_environment import capture as capture_build_environment
    ...
    write_yaml_file(
        {
            ...
            "generator": {
                "name": "generators/lib/source-formats/eqtlgen-besd-ragged/generate.py",
                "command": f"python3 generators/lib/source-formats/eqtlgen-besd-ragged/generate.py --config={args.config}",
            },
    ...
    merge_validation_yaml(
        ...
        validator_name="generators/lib/source-formats/eqtlgen-besd-ragged/generate.py",
        updated_checks={
