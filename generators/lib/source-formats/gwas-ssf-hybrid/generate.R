...
##
## Structurally mirrors generators/lib/source-formats/gwas-ssf-ragged/generate.R
...
script_version <- function(root) {
  path <- path_abs(root, "generators/lib/source-formats/gwas-ssf-hybrid/generate.R")
...
emit_bundle <- function(cfg, root) {
  ...
  command <- paste("Rscript generators/lib/source-formats/gwas-ssf-hybrid/generate.R",
  ...
  write_yaml_file(list(
    ...
    accepted_at = NULL,
    generator = list(
      name = "generators/lib/source-formats/gwas-ssf-hybrid/generate.R",
  ...
  write_yaml_file(list(
    status = "not_run",
    validated_at = NULL,
    validator = list(name = "generators/lib/source-formats/gwas-ssf-hybrid/generate.R", version = NULL),
...
validate_emit <- function(cfg, root) {
  ...
  if (!schema$passed) {
    merge_validation_checks(
      ...
      "generators/lib/source-formats/gwas-ssf-hybrid/generate.R"
    )
    stop(
...
# generators/lib/effect_scale_validation.R's phenotype-SD estimator shells out
...
# Reuses generators/lib/effect_scale_validation.R's engine unchanged --
...
root <- repo_root()
source(path_abs(root, "generators/lib/gwas_catalog_ssf_url.R"))
source(path_abs(root, "generators/lib/effect_scale_validation.R"))
source(path_abs(root, "generators/lib/effect_scale_stage_yaml.R"))
source(path_abs(root, "generators/lib/build_environment.R"))
source(path_abs(root, "generators/lib/schema_validate.R"))
source(path_abs(root, "generators/lib/metadata_resolvers/ontology_contract.R"))
source(path_abs(root, "generators/lib/metadata_resolvers/canonical_trait_table.R"))
