...
# Table Reference Resource (resources/reference-resources/canonical-trait-mapping-efo/,
...
#' resources/reference-resources/canonical-trait-mapping-efo/mapping.tsv) for use with
