...
# separate from resources/generators/lib/source-formats/opengwas-gwas-vcf-dense/generate.R
...
# keeping generator CLI drivers thin over a sourceable resources/generators/lib/*.R
# module (see resources/generators/lib/effect_scale_validation.R).
...
apply_resolution <- function(candidates, resolution) {
  ...
  # matching resources/generators/lib/metadata_resolvers/contract.R's
...
# resources/generators/lib/metadata_resolvers/canonical_trait_table.R's
