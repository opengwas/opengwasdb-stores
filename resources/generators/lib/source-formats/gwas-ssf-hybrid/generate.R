...
##
## Structurally mirrors resources/generators/lib/source-formats/gwas-ssf-ragged/generate.R
...
script_version <- function(root) {
  path <- path_abs(root, "resources/generators/lib/source-formats/gwas-ssf-hybrid/generate.R")
...
emit_bundle <- function(cfg, root) {
  ...
  command <- paste("Rscript resources/generators/lib/source-formats/gwas-ssf-hybrid/generate.R",
  ...
  write_yaml_file(list(
    ...
    accepted_at = NULL,
    generator = list(
      name = "resources/generators/lib/source-formats/gwas-ssf-hybrid/generate.R",
  ...
  write_yaml_file(list(
    status = "not_run",
    validated_at = NULL,
    validator = list(name = "resources/generators/lib/source-formats/gwas-ssf-hybrid/generate.R", version = NULL),
...
validate_emit <- function(cfg, root) {
  ...
  if (!schema$passed) {
    merge_validation_checks(
      ...
      "resources/generators/lib/source-formats/gwas-ssf-hybrid/generate.R"
    )
    stop(
...
# resources/generators/lib/effect_scale_validation.R's phenotype-SD estimator shells out
...
# Reuses resources/generators/lib/effect_scale_validation.R's engine unchanged --
