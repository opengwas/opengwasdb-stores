...
from resources.generators.lib.release_yaml import merge_validation_yaml, read_tsv  # noqa: E402
...
def main() -> None:
    ...
    merge_validation_yaml(
        ...
        validator_name="resources/generators/lib/source-formats/finngen-r13-dense/acquire.py",
