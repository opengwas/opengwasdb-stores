...
script_version <- function(root) {
  path <- path_abs(root, "resources/generators/lib/source-formats/gwas-ssf-ragged/generate.R")
...
emit_bundle <- function(cfg, root) {
  ...
  command <- paste("Rscript resources/generators/lib/source-formats/gwas-ssf-ragged/generate.R",
  ...
  write_yaml_file(list(
    ...
    accepted_at = NULL,
    generator = list(
      name = "resources/generators/lib/source-formats/gwas-ssf-ragged/generate.R",
  ...
  write_yaml_file(list(
    status = "not_run",
    validated_at = NULL,
    validator = list(name = "resources/generators/lib/source-formats/gwas-ssf-ragged/generate.R", version = NULL),
    checks = list(
      schema = "not_run",
      files = "not_run",
...
validate_emit <- function(cfg, root) {
  ...
  if (!schema$passed) {
    merge_validation_checks(
      ...
      "resources/generators/lib/source-formats/gwas-ssf-ragged/generate.R"
    )
    stop(
