...
`resources/generators/lib/source-formats/gwas-ssf-ragged/`. The engine is generic across all
...
```sh
pixi run Rscript resources/generators/pqtl-interval-2018/generate.R --mode=emit
pixi run Rscript resources/generators/pqtl-interval-2018/generate.R --mode=validate
```

Run sparse filtering with:

```sh
pixi run Rscript resources/generators/pqtl-interval-2018/generate.R --mode=filter
```
